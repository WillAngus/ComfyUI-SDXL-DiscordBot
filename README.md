...
### 2. **Configuration**
- Open `config.properties` using a text editor. If cloned from github, rename and `config.properties.example`.
...
***Developent:***
- If using Double-click on `start_bot_py.bat` to launch.
